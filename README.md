...
To compile a simple C program of sum 1 to n numbers using both GCC and RISC-V GCC compilers. To understand the compilation flow and analyze the generated RISC-V assembly instructions.
