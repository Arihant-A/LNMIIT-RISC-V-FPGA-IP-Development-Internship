...
|--------|--------|-----|--------------|---------------------------------------|
| 0x00   | CTRL   | R/W | 0x0000_0003  | Enable and polarity control           |
| 0x04   | PERIOD | R/W | 0x0000_03E8  | PWM period, in clock ticks (Default: 1000) |
| 0x08   | DUTY   | R/W | 0x0000_0064  | High time, in clock ticks (Default: 100)   |
